...
//set dimensions of pop up
        ...
        db6 = FirebaseDatabase.getInstance().getReference().child("Stats").child(currentuser).child(curr_team).child(team).child("Our 22").child("Forced Turnover");
        ...
        db2 = FirebaseDatabase.getInstance().getReference().child("Stats").child(currentuser).child(curr_team).child(team).child("Our 22").child("Unforced Turnover");
        ...
        db3 = FirebaseDatabase.getInstance().getReference().child("Stats").child(currentuser).child(curr_team).child(team).child("Our 22").child("Linebreaks Made");
        ...
        db4 = FirebaseDatabase.getInstance().getReference().child("Stats").child(currentuser).child(curr_team).child(team).child("Our 22").child("Turnover Won");
        ...
        db5 = FirebaseDatabase.getInstance().getReference().child("Stats").child(currentuser).child(curr_team).child(team).child("Our 22").child("Tackles Missed");
...
//Add bar colours
                colors.add(ContextCompat.getColor(ViewPopup.this, R.color.Red));;
                colors.add(ContextCompat.getColor(ViewPopup.this, R.color.Red));
                colors.add(ContextCompat.getColor(ViewPopup.this, R.color.Green));
                colors.add(ContextCompat.getColor(ViewPopup.this, R.color.Green));
                colors.add(ContextCompat.getColor(ViewPopup.this, R.color.Red));
