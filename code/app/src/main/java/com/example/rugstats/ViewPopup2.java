...
public class ViewPopup2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db6 = FirebaseDatabase.getInstance().getReference().child("Stats").child(currentuser).child(curr_team).child(team).child("Our Half").child("Forced Turnover");
        ...
        db2 = FirebaseDatabase.getInstance().getReference().child("Stats").child(currentuser).child(curr_team).child(team).child("Our Half").child("Unforced Turnover");
        ...
        db3 = FirebaseDatabase.getInstance().getReference().child("Stats").child(currentuser).child(curr_team).child(team).child("Our Half").child("Linebreaks Made");
        ...
        db4 = FirebaseDatabase.getInstance().getReference().child("Stats").child(currentuser).child(curr_team).child(team).child("Our Half").child("Turnover Won");
        ...
        db5 = FirebaseDatabase.getInstance().getReference().child("Stats").child(currentuser).child(curr_team).child(team).child("Our Half").child("Tackles Missed");
        db5.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                colors.add(ContextCompat.getColor(ViewPopup2.this, R.color.Red));;
                colors.add(ContextCompat.getColor(ViewPopup2.this, R.color.Red));
                colors.add(ContextCompat.getColor(ViewPopup2.this, R.color.Green));
                colors.add(ContextCompat.getColor(ViewPopup2.this, R.color.Green));
                colors.add(ContextCompat.getColor(ViewPopup2.this, R.color.Red));
